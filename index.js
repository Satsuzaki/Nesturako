...
bot.on("message", function(message) {
    ...
    case "rrct":
        ...
        .addField("- Club Otaku:", ":japan:")
        .addField("- Club du Jeux-vidéo:", ":video_game:")
        .addField("- Club Rôleplay:", ":scroll:")
        .addField("- Club du Cinéma:", ":clapper:")
        .addField("- Club Nature:", ":sunrise_over_mountains:")
        .addField("- Club de Musique:", ":musical_keyboard: ")
        .addField("- Club d'Art:", ":art:")
        .addField("- Club de Sport:", ":soccer:")
        .addField("- Club de Spammeur:", ":no_entry:")
        .addField("- Etudiant:", ":triangular_ruler:")
        .setColor("#32ca2b")
        message.channel.sendEmbed(embed)
    }
})
