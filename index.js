...
bot.on("message", function(message) {
    ...
    case "rrct":
        const embed = new Discord.RichEmbed()
        .setTitle ("**__Intégrez 2 Clubs (max)__**")
        .addField(":arrow_right: Otaku", ":japan:")
        .addField(":arrow_right: Jeux-vidéo", ":video_game:")
        .addField(":arrow_right: Rôleplay", ":scroll:")
        .addField(":arrow_right: Cinéma", ":clapper:")
        .addField(":arrow_right: Nature", ":sunrise_over_mountains:")
        .addField(":arrow_right: Musique", ":musical_keyboard: ")
        .addField(":arrow_right: Art", ":art:")
        .addField(":arrow_right: Sport", ":soccer:")
        .addField(":arrow_right: Spammeur", ":no_entry:")
        .addField(":arrow_right: Etudiant", ":triangular_ruler:")
        .setColor("#32ca2b")
        message.channel.sendEmbed(embed)
    }
})
